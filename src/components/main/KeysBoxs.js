    ...
    <div className={styles.wrapperKeys}>
      {data.allWpPost.nodes.map((item, index) => {
        ...
        return (
          ...
          >
            <div className={styles.caseBgImg} style={divStyle}></div>
            <div className={styles.title}>Кейсы</div>
            <div className={classnames(styles.nameKeys)}>{item.title}</div>
            <ButtonSmall grey className={classnames(styles.button)}>
