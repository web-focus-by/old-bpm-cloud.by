    ...
    <div className={styles.wrapperFeedback}>
      <div className={styles.boxGreen}>
        <div className={styles.box}>
          ...
          <div className={styles.text} dangerouslySetInnerHTML={{__html:currentContent}}>
          </div>
...
const IconNew = ({socialNetwork}) => {
  ...
  return(
    <div className={styles.iconAreaWrapper}>
      {socialNetworkArr}
    </div>
  )
}
