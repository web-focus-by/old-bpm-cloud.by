...
import styles from "./NothingPersonal.module.scss"
...
function PparagraphList(props) {
  ...
  return <div className={styles.text}>{paragList}</div>
}

const content = [
  "«Ничего личного» – не про нас 100%! Агентство интернет-маркетинга «BPM Cloud» представляет собой сообщество прогрессивных людей, которые не первый год увлечены профессиональным самосовершенствованием. Мы проявляем себя в проектах заказчиков. За каждой площадкой стоят творческие поиски и математический расчет.",
