...
const Cirlce = () => {
  ...
  return (
    <div className={classnames(styles.circle, {[styles.modalIsOpen]:modalIsOpen})}>
      <svg
        viewBox="0 0 192 192"
        fill="none"
      ...
      >
        ...
        <circle cx="95.9355" cy="95.5304" r="58" transform="rotate(63.9197 95.9355 95.5304)" stroke="#309195" strokeWidth="20"/>
        <path d="M46.2451 81.9062C47.3334 78.0987 45.4918 74.5208 41.8747 73.4869C38.2576 72.453 34.8033 74.5171 33.7149 78.3246C32.6216 82.1495 34.4855 85.715 38.0853 86.744C41.6852 87.7729 45.1518 85.731 46.2451 81.9062ZM43.8568 81.2235C43.2384 83.3869 41.1984 84.5636 38.8966 83.9056C36.5948 83.2477 35.4849 81.1707 36.1033 79.0073C36.7216 76.844 38.7616 75.6673 41.0634 76.3252C43.3652 76.9832 44.4751 79.0602 43.8568 81.2235Z" fill="white"/>
        <path d="M51.5108 68.5243L55.1425 63.7785C57.1116 61.2055 57.0805 58.847 55.0792 57.3156C53.1637 55.8497 51.1391 56.3629 49.2903 58.7787L47.1682 61.5519L45.1097 59.9766L49.5291 54.2016L47.6851 52.7905L41.5045 60.8669L51.5108 68.5243ZM51.5566 64.9102L48.8692 62.8536L50.6414 60.5379C51.5712 59.3228 52.4704 59.0363 53.3567 59.7146C54.2572 60.4037 54.2367 61.408 53.3287 62.5944L51.5566 64.9102Z" fill="white"/>
        <path d="M68.9189 51.757C70.7776 50.5876 71.8947 48.9492 72.1239 47.0825L69.6192 46.6167C69.4303 47.9051 68.7998 48.8972 67.7333 49.5682C65.7374 50.8238 63.4387 50.3136 62.1734 48.3024C60.9082 46.2913 61.4433 43.9982 63.4392 42.7426C64.5057 42.0716 65.673 41.9327 66.9066 42.305L67.571 39.8455C65.7986 39.2592 63.8381 39.557 61.9946 40.7167C58.6732 42.8063 57.6523 46.6596 59.6748 49.8744C61.6972 53.0891 65.6127 53.8369 68.9189 51.757Z" fill="white"/>
        <path d="M85.8048 32.0297L83.8027 39.3606L79.144 33.4182L76.0955 34.0537L82.847 42.0972L82.7707 42.2602C82.4492 43.0995 81.969 43.5305 81.2642 43.6774C80.8941 43.7546 80.4705 43.7509 79.9829 43.7055L79.7475 46.0161C80.4935 46.1548 81.1925 46.1562 81.8445 46.0203C83.5009 45.675 84.7651 44.4186 85.3904 42.3025L88.6066 31.4457L85.8048 32.0297Z" fill="white"/>
        <path d="M109.775 43.0621L111.403 32.9686L101.842 31.4266L101.073 35.2954C100.386 38.7583 99.5478 41.358 97.9221 41.1504L97.4245 41.0702L96.6129 45.9897L99.2784 46.4196L99.694 43.8429L108.473 45.2588L108.057 47.8355L110.723 48.2654L111.516 43.343L109.775 43.0621ZM103.571 35.9718L103.916 34.1678L108.181 34.8557L106.932 42.6036L101.37 41.7065C102.386 40.8311 103.037 38.6024 103.571 35.9718Z" fill="white"/>
        <path d="M117.196 48.1049L119.566 49.5083L128.912 45.525L124.739 52.5719L127.217 54.0394L133.638 43.1981L131.283 41.8039L121.928 45.8027L126.111 38.7403L123.617 37.2636L117.196 48.1049Z" fill="white"/>
        <path d="M148.891 58.7346L141.941 50.304L140.107 51.8154L142.661 54.9126L134.772 61.4161L136.604 63.6383L144.493 57.1349L147.057 60.246L148.891 58.7346Z" fill="white"/>
        <path d="M152.669 75.4603L151.536 72.4634L155.408 70.9992L154.384 68.2885L142.598 72.7448L144.61 78.0651C145.755 81.0957 147.84 82.3857 150.551 81.3608C153.093 80.3995 153.745 78.3057 152.669 75.4603ZM146.573 77.1497L145.643 74.6915L149.516 73.2273L150.445 75.6855C150.98 77.0998 150.759 78.1453 149.463 78.6355C148.133 79.1384 147.101 78.5471 146.573 77.1497Z" fill="white"/>
        ...
        <path d="M88.9622 147.033L85.6614 146.761L89.3602 153.604L84.7526 159.329L87.8203 159.582L91.5392 154.777L93.6202 154.948L93.202 160.025L96.0903 160.263L97.1246 147.705L94.2363 147.467L93.8197 152.526L91.8105 152.361L88.9622 147.033Z" fill="white"/>
        <path d="M64.9613 152.335L74.94 156.785L75.9077 154.615L72.2418 152.98L76.4059 143.642L73.7756 142.469L69.6115 151.807L65.929 150.165L64.9613 152.335Z" fill="white"/>
        </g>
        <circle cx="95.9713" cy="94.9722" r="10" transform="rotate(-126.108 95.9713 94.9722)" fill="#309195" className={styles.centralCircle}/>
        <defs>
          <clipPath id="clip0">
            <rect
              width="137"
      ...
      return (
        <div className={classnames(styles.successPage)}>
          ...
          <div className={styles.buttonWrapper}>
            <button className = {classnames(styles.button, styles.modalButton)} onClick={closeModal}>
              Окей, я жду
            </button>
          </div>
        </div>
