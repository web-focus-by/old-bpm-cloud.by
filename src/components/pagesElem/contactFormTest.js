    ...
    return (
        <div className={style.inputAreaWrapper}>
          <div className={style.textAreaWrapper}>
            ...
            ref={itemsRef.current[state.currentStep - 1]}
            />
            <label htmlFor="file" className={style.inputWrapper}>
              <div className={style.inputImage}><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
