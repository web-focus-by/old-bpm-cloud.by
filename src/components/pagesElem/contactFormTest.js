  ...
  const successLabel = () =>{
    ...
    return (
      <div className={style.successLabel}>
        ...
        <rect width="1.94699" height="19.5143" transform="matrix(-0.707107 0.707107 0.707107 0.707107 2.16553 15.3418)" fill="white"/>
        <rect width="1.94699" height="40.259" transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 43.0537 2.0542)" fill="white"/>
      </svg>
      </div>
    )
  }
